  ...
  <div class="page-hero">
    <div class="container">
      ...
      <p class="ingress" style="color:rgba(255,255,255,.85);">
        Piirihallitus vastaa Uudenmaan Vihreiden toiminnan johtamisesta yleiskokouksien välillä.
      </p>
    </div>
  </div>
    ...
    <div class="container">
      ...
      <div class="grid-2" style="gap:3rem;align-items:start;">
        ...
        <div>
          ...
          <h2 style="margin-top:2rem;">Varajäsenet 2026</h2>
          <p style="font-size:.85rem;color:#666;margin-bottom:.5rem;">Sisääntulojärjestyksessä</p>
        ...
        <div>
          <h2>Puoluehallituksen jäsenet</h2>
          ...
          <h2 style="margin-top:2rem;">Puoluevaltuusto</h2>
          <p style="font-size:.85rem;color:#666;margin-bottom:.5rem;">2025–2027</p>
          <ul class="member-list" style="columns:1;margin-top:.5rem;">
          ...
          <h2 style="margin-top:2rem;">Piirin työalat</h2>
          <div class="grid-2" style="gap:1rem;margin-top:1rem;">
            <div class="highlight-box" style="padding:1rem;">
              <h3 style="font-size:1rem;margin-bottom:0.4rem;">Koulutus</h3>
              <p style="font-size:0.85rem;margin:0;">Daniela Metsäranta, Säde Heikinheimo, Teemu Ojanne</p>
            </div>
            <div class="highlight-box" style="padding:1rem;">
              <h3 style="font-size:1rem;margin-bottom:0.4rem;">Vaalit</h3>
              <p style="font-size:0.85rem;margin:0;">Eduskuntavaaleihin asti vaalityöstä vastaa piirin vaalityöryhmä, puheenjohtaja Börje Uimonen.</p>
            </div>
            <div class="highlight-box" style="padding:1rem;">
              <h3 style="font-size:1rem;margin-bottom:0.4rem;">Vapaaehtoiset</h3>
              <p style="font-size:0.85rem;margin:0;">Marjo Hinkkala, Kari Laalo</p>
            </div>
            <div class="highlight-box" style="padding:1rem;">
              <h3 style="font-size:1rem;margin-bottom:0.4rem;">Politiikka</h3>
              <p style="font-size:0.85rem;margin:0;">Sanna Tuhkunen, Heidi Anttila</p>
            </div>
          </div>

          <h2 style="margin-top:2rem;">Piirin vaalityöryhmä</h2>
